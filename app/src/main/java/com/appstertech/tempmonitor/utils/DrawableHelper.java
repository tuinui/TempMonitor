package com.appstertech.tempmonitor.utils;
...
public class DrawableHelper {
    ...
    public static DrawableHelper xwithContext(@NonNull Context context) {
    ...
    public DrawableHelper tint() {
        ...
        DrawableCompat.setTint(mWrappedDrawable, ContextCompat.getColor(mContext,mColor));
